...
class TicketsFbDatasource extends ITicketsDatasource {
  ...
  final List<Ticket> tickets = [
    ...
    Ticket(
      ...
      asssignedAt: DateTime.now().subtract(const Duration(minutes: 9)),
    ...
    Ticket(
      ...
      asssignedAt: DateTime.now().subtract(const Duration(hours: 1, minutes: 30)),
      openedAt: DateTime.now().subtract(const Duration(hours: 1)),
      closedAt: DateTime.now().subtract(const Duration(minutes: 30)),
      hasFeedback: false,
    ),
    Ticket(
      id: '004',
    ...
    Ticket(
      ...
      deviceId: '003',
      technicianId: '002',
      createdAt: DateTime.now().subtract(const Duration(days: 1, hours: 3, minutes: 30)),
      asssignedAt: DateTime.now().subtract(const Duration(days: 1, hours: 3, minutes: 10)),
    ...
    Ticket(
      ...
      asssignedAt: DateTime.now().subtract(const Duration(days: 8, hours: 4, minutes: 30)),
      openedAt: DateTime.now().subtract(const Duration(days: 8, hours: 4)),
      closedAt: DateTime.now().subtract(const Duration(days: 7, hours: 20)),
      hasFeedback: true,
    ),
    Ticket(
      id: '007',
      ...
      deviceId: '002',
      technicianId: '007',
      createdAt: DateTime.now().subtract(const Duration(days: 20, hours: 3)),
      asssignedAt: DateTime.now().subtract(const Duration(days: 20, hours: 2, minutes: 30)),
      openedAt: DateTime.now().subtract(const Duration(days: 20)),
      closedAt: DateTime.now().subtract(const Duration(minutes: 5)),
      hasFeedback: false,
    ),
    Ticket(
      id: '008',
      ...
      deviceId: '001',
      technicianId: '008',
      createdAt: DateTime.now().subtract(const Duration(days: 31, hours: 2)),
      asssignedAt: DateTime.now().subtract(const Duration(days: 31, hours: 1, minutes: 30)),
      openedAt: DateTime.now().subtract(const Duration(days: 31, hours: 1, minutes: 10)),
      closedAt: DateTime.now().subtract(const Duration(hours: 5)),
      hasFeedback: false,
    ),
  ];
